...
func TestDo(t *testing.T) {
	...
	want := "val"
	got, shared, err := g.Do(context.Background(), "key", func(ctx context.Context) (string, error) {
		return want, nil
	})
	if err != nil {
		t.Fatal(err)
...
func TestDo_error(t *testing.T) {
	...
	got, _, err := g.Do(context.Background(), "key", func(ctx context.Context) (any, error) {
		return nil, wantErr
	})
	if err != wantErr {
